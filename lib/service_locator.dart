...
import 'package:weather_app/accembly/data_domain_boundary/model/weather.dart';
...
import 'package:weather_app/accembly/weather_dto_from_json_factory.dart';
...
void init() {
  sl.registerLazySingleton<Factory<WeatherDto, Map<String, dynamic>>>(
      () => DtoFromJsonFactory());
  sl.registerLazySingleton<Factory<Weather, WeatherDto>>(
  ...
  sl.registerLazySingleton<BaseRestGateWay>(() => BaseRestGateWay());
